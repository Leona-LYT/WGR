...
# =============================================================================
def L1L2_MSE_mean_sd_G(G, loader_dataset, noise_dim, test_size, batch_size, J_t_size=50, model_type="M1", Ydim=1, is_multivariate=False):
    """
...
# =============================================================================
def MSE_quantile_G_uniY(G, loader_dataset,  noise_dim, test_size, batch_size, J_t_size=500, model_type="M1" ):
    """
